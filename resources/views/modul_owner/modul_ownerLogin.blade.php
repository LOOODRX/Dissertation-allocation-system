...
<head>
  ...
  <style>
    .auth1-side-wrapper{
        width: 100%;
        height:100% ;
        background-image: url({{ asset('label/label2.jpg') }})
    }

</style>

	<title>Module Owner login page</title>
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Dissertation Topic<span>Selection</span></a>
