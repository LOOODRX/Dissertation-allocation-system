            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('student.update.password') }}" class="forms-sample">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="new_password_confirmation" class="form-control"  id="new_password_comfirmation" autocomplete="off" >
                            </div>
