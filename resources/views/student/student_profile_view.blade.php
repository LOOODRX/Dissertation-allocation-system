        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('student.profile.store') }}" class="forms-sample" enctype="multipart/form-data">
                      @csrf
                                    
                    <div class="mb-3">
                        <label for="exampleInputUsername1" class="form-label">ID</label>
                        <input type="text" name="id" class="form-control" id="exampleInputUsername1" autocomplete="off" value="{{ $profileData->id}}">
                    </div>
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/student_images/'.$profileData->photo) : url(('upload/no_image.jpg'))}}" alt="profile">
                            </div>

                      <button type="submit" class="btn btn-primary me-2">Save Chaneges</button>
